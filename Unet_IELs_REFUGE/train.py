...
from dataset import REFUSEDataset
...
dir_predictions = '/home/cl920/rds/hpc-work/data/DRIVE_augmented/predictions'
dir_checkpoint = '/home/cl920/rds/hpc-work/data/DRIVE_augmented/checkpoints/'

train_x = sorted(glob("/home/cl920/rds/hpc-work/data/REFUGE/train/Images/*"))
train_y = sorted(glob("/home/cl920/rds/hpc-work/data/REFUGE/train/Masks/*"))
valid_x = sorted(glob("/home/cl920/rds/hpc-work/data/REFUGE/val/Images/*"))
valid_y = sorted(glob("/home/cl920/rds/hpc-work/data/REFUGE/val/Masks/*"))
...
def train_net(net,
    ...
    # 2. Create dataset
    train_dataset = REFUSEDataset(train_x, train_y)
    val_dataset = REFUSEDataset(valid_x, valid_y)
...
def get_args():
    ...
    parser.add_argument('--add_gradientloss', action='store_true', default=False, help='Add gradient loss')
